...
class ScheduleFragment: BaseFragment() {
    ...
    private fun observeCreateTask() {
        viewModel.observeCreateTask().observe(this, androidx.lifecycle.Observer {
            result ->
            ...
            if (result is Result.Error) {
                Snackbar.make( root, result.exception.message ?: "An error accour while creating the task", Snackbar.LENGTH_LONG).show()
            }
        })
    }
    ...
    private fun showDatePicker() {
        ...
        val datePickerDialog = DatePickerDialog(mContext, OnDateSetListener {
