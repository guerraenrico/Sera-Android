...
import com.guerra.enrico.sera.ui.base.viewmodel.Converter
import com.guerra.enrico.sera.ui.base.viewmodel.ViewModelState
import com.guerra.enrico.sera.ui.base.viewmodel.ViewState
...
open class BaseViewModel<VMS : ViewModelState, VS : ViewState>(
  ...
  private val viewModelState = BehaviorSubjectChannel(initialState)
